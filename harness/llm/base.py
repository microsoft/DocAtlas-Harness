...
The loop only knows about the abstract `LLMBackend` defined here. Phase 2
ships only `azure_responses.AzureResponsesBackend`, but later phases can
add Anthropic / Qwen-VL / local backends without touching the loop.
"""
